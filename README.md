...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create drakenfruit-portaal-c524
  fly apps create drakenfruit-portaal-c524-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app drakenfruit-portaal-c524
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app drakenfruit-portaal-c524-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'drakenfruit-portaal-c524-staging' does not match app name in config file 'drakenfruit-portaal-c524'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name drakenfruit-portaal-c524-db
  fly postgres attach --app drakenfruit-portaal-c524 drakenfruit-portaal-c524-db

  fly postgres create --name drakenfruit-portaal-c524-staging-db
  fly postgres attach --app drakenfruit-portaal-c524-staging drakenfruit-portaal-c524-staging-db
  ```
