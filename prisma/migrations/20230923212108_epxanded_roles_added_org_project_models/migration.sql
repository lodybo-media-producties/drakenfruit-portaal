/*
  ...
  - The values [PROJECTMANAGER] on the enum `Role` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "Role_new" AS ENUM ('MAINTAINER', 'ADMIN', 'OFFICEMANAGER', 'CONSULTANT', 'PROJECTLEADER');
